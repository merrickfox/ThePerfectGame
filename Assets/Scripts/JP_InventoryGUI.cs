...
public class JP_InventoryGUI : MonoBehaviour {
	...
	static public Dictionary<int, Item_Class.ItemClass> inventoryNameDictionary = new Dictionary<int, Item_Class.ItemClass>()
	{
		...
		{1, itemObject.spikeTrap_c},
		{2, itemObject.bearTrap_c},
		{3, itemObject.cageTrap_c},
		{4, itemObject.snareTrap_c},
		{5, itemObject.Rod_c},
		{6, itemObject.electricHuman_c},
		{7, itemObject.electricNetTrap_c},
		{8, itemObject.balloonTrap_c},
		{9, itemObject.mouse_b},
		{10, itemObject.book_b},
		{11, itemObject.sextape_b},
		{12, itemObject.snake_b},
		{13, itemObject.goth_b},
		{14, itemObject.mayor_b},
		{15, itemObject.druggy_b},
		{16, itemObject.drunk_b},
		{17, itemObject.raccoon_b},
