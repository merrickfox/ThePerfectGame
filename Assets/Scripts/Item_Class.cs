...
public class Item_Class : MonoBehaviour {
	...
	public static Texture2D bowIcon = (Texture2D)Resources.Load ("Textures/Traps/Bow_Trap");
	...
	public ItemClass bow_c = new ItemClass(22, 2, "Bow", bowIcon, "Bow. Best used with arrows.", true);
